...
const SITE = {
  name: "Commercial Roofing Contractors of Lansing",
  domain: "commercialroofingcontractorslansing.com",
  email: "contact@commercialroofingcontractorslansing.com",
  phone: "555-555-6149"
};
...
async function sendEmail({ to, subject, html, replyTo }) {
  ...
  const response = await fetch("https://api.sendgrid.com/v3/mail/send", {
    ...
    body: JSON.stringify({
      ...
      categories: ["contact-form", "commercialroofingcontractorslansing-com"]
    })
  });
